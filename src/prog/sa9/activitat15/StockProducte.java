...
public class StockProducte {
    ...
    public StockProducte(Producte producte, int unitatsDisponibles) {
        // Comprovem que el producte existisca
        assert producte != null : "El producte no pot ser null";

        // Comprovem que les unitats inicials siguen positives
    ...
    /**
     * Decrementa les unitats disponibles després d'una compra.
     *
     * @param quantitat nombre d'unitats a restar
     */
    public void decrementarUnitats(int quantitat) {
        // Comprovem que la quantitat a decrementar siga positiva
        assert quantitat > 0 : "La quantitat a restar ha de ser positiva";

        // Comprovem que no es deixe el stock en un valor negatiu
